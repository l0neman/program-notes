...
- [ 发送流程分析](#-发送流程分析)
  - [Client](#client-1)
    ...
    - [ActivityManagerProxy](#activitymanagerproxy-1)
  - [Server](#server-1)
...
- [分发流程分析](#分发流程分析)
  ...
  - [Client](#client-2)
    ...
    - [ReceiverDispatcher](#receiverdispatcher-1)
    - [Args](#args)
  - [静态注册广播分发](#静态注册广播分发)
    - [BroadcastHandler](#broadcasthandler-1)
    - [ApplicationThread](#applicationthread-1)
